/**
 * Type definitions for VP Daemon system
...
export interface TieredModelConfig {
  /** Model configuration for VP (Tier 1) */
...
export interface VPIdentity {
  /** Display name of the VP */
  name: string;
  /** Email address associated with the VP */
  email: string;
  /** Avatar URL or path */
  avatar?: string;
  /** Slack handle for the VP */
  slackHandle: string;
}

/**
 * Resource limits for VP operations
 */
...
/**
 * Measurable objectives for VP performance
 */
...
/**
 * VP Charter defining role, responsibilities, and constraints
 */
...
/**
 * System resource limits for the VP daemon
 */
...
/**
 * Complete VP Daemon configuration
 */
export interface VPDaemonConfig {
  /** VP Charter defining identity and constraints */
  charter: VPCharter;
  /** PTY controller configuration */
