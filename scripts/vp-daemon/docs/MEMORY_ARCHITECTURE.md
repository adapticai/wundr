...
- **Decay Rate**: 0.05 (slower than default for important VP memories)
...
```bash
# Manual archive
npm run vp-daemon -- archive --older-than 90
...
The VP Memory System is built on top of `@wundr.io/agent-memory`, leveraging:
