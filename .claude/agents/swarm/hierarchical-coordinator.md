...
- **Spawn Command**:
  `mcp__ruflo__agent_spawn researcher --capabilities="research,analysis,information_gathering"`
...
- **Spawn Command**:
  `mcp__ruflo__agent_spawn coder --capabilities="code_generation,testing,optimization"`
...
- **Spawn Command**:
  `mcp__ruflo__agent_spawn analyst --capabilities="data_analysis,performance_monitoring,reporting"`
...
- **Spawn Command**:
  `mcp__ruflo__agent_spawn tester --capabilities="testing,validation,quality_assurance"`
