...
description:
  Performance Optimization Agent for comprehensive benchmarking and testing. Use for automated
  performance testing, regression detection, and performance validation.
