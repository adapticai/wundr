...
description:
  Performance Optimization Agent for dynamic swarm topology reconfiguration. Use for network
  optimization, agent placement strategies, and communication pattern optimization.
