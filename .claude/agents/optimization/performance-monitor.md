...
description:
  Performance Optimization Agent for real-time metrics collection and bottleneck analysis. Use for
  SLA monitoring, resource tracking, anomaly detection, and performance dashboards.
