...
description:
  Performance Optimization Agent for adaptive resource allocation. Use for predictive scaling,
  capacity planning, circuit breaker patterns, and performance profiling.
