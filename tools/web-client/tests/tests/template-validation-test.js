...
const validationResult = TemplateService_1.TemplateService.validateParameters(
  testTemplate,
  { message: 'Hello' }
);
...
const invalidValidationResult =
  TemplateService_1.TemplateService.validateParameters(testTemplate, {});
...
console.log(
  'First result:',
  (_a = searchResults[0]) === null || _a === void 0 ? void 0 : _a.name
);
// Test 4: searchTemplates with string query (backward compatibility)
const stringSearchResults =
  TemplateService_1.TemplateService.searchTemplates('test');
