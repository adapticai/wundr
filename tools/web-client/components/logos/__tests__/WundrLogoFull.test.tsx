...
describe('WundrLogoFull', () => {
  ...
  it('renders vertical layout when specified', () => {
    const { container } = render(<WundrLogoFull orientation='vertical' />);
  ...
  it('shows tagline when showTagline is true', () => {
    ...
    expect(
      screen.getByText(/Transform your monorepo with intelligent/)
    ).toBeInTheDocument();
  });
  ...
  it('shows attribution when showAttribution is true', () => {
    ...
    expect(
      screen.getByText('A product by Wundr, by Adaptic.ai')
    ).toBeInTheDocument();
  });
  ...
  it('hides tagline when showTagline is false', () => {
    ...
    expect(
      screen.queryByText(/Transform your monorepo with intelligent/)
  ...
  it('hides attribution when showAttribution is false', () => {
    ...
    expect(
      screen.queryByText('A product by Wundr, by Adaptic.ai')
    ).not.toBeInTheDocument();
  });
  ...
  it('applies custom className', () => {
    const { container } = render(<WundrLogoFull className='custom-class' />);
  ...
  it('renders split tagline text correctly in vertical layout', () => {
    ...
    expect(
      screen.getByText('code analysis and refactoring')
    ).toBeInTheDocument();
  });
