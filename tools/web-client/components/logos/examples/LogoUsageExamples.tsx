    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-16">
        ...
        <nav className="flex items-center space-x-4">
          ...
          <a href="/github" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white text-sm">
            GitHub
          </a>
        </nav>
      </div>
    ...
    <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 max-w-2xl mx-auto">
        <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
          Start analyzing and refactoring your monorepo today with intelligent tooling 
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">Changelog</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">Documentation</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">API Reference</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">Examples</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">Help Center</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm">Community</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            © 2024 Lumic.ai. All rights reserved.
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-6 max-w-md">
    ...
    <div className="space-y-3">
      <p className="text-gray-600 dark:text-gray-400 text-sm">
        Advanced monorepo tooling with intelligent code analysis, automated refactoring, 
        and comprehensive project insights.
      </p>
...
export const SidebarExample: React.FC = () => (
  <aside className="bg-white dark:bg-gray-800 w-64 h-screen border-r border-gray-200 dark:border-gray-700 p-4">
    ...
    <nav className="space-y-2">
      <a href="#" className="flex items-center px-2 py-2 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-100 dark:hover:bg-gray-700">
        Dashboard
      </a>
      <a href="#" className="flex items-center px-2 py-2 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-100 dark:hover:bg-gray-700">
        Analysis
