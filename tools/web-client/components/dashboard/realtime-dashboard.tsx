    ...
    <div className='space-y-6'>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {performanceData && performanceData.length > 0
                ? `${performanceData[performanceData.length - 1].buildTime}ms`
                : '--'}
            </div>
            <p className='text-xs text-muted-foreground'>Latest build time</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityData && qualityData.length > 0
                ? `${qualityData[qualityData.length - 1].testCoverage.toFixed(1)}%`
                : '--'}
            </div>
      ...
      <Tabs defaultValue='performance' className='space-y-4'>
        ...
        <TabsContent value='performance' className='space-y-4'>
          <PerformanceMetrics data={performanceData} realtime={realtime} />
        </TabsContent>
        ...
        <TabsContent value='git' className='space-y-4'>
          <GitActivityHeatmap activities={gitData || []} days={365} />
        </TabsContent>
      </Tabs>
