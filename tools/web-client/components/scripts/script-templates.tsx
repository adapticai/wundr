  ...
  const templates: ScriptTemplate[] = [
    {
      ...
      description:
        'Simple code analysis to detect basic issues and get project overview',
      category: 'analysis',
    ...
    },
    {
      ...
      description:
        'Full analysis including duplicates, dependencies, and quality metrics',
      category: 'analysis',
    ...
    },
    {
      ...
      description:
        'Create a quality baseline for drift detection and monitoring',
      category: 'governance',
    ...
    },
    {
      ...
      description:
        'Generate comprehensive health report for monorepo structure',
      category: 'monorepo',
    ...
    },
    {
      ...
      description:
        'Audit code for performance issues and optimization opportunities',
      category: 'quality',
  ...
  const handleUseTemplate = (template: ScriptTemplate) => {
    ...
    const script: ScriptFromTemplate = {
      ...
      estimatedDuration: template.estimatedTime.includes('minutes')
        ? parseInt(template.estimatedTime) * 60000
        : 30000,
    ...
    <div className='space-y-4'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pre-configured script templates for common analysis and maintenance
            tasks
          </CardDescription>
        </CardHeader>
        <CardContent>
