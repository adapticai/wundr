...
export default function DependenciesAnalysisPage() {
  ...
  const loadDependencyData = useCallback(async (refresh = false) => {
    ...
    try {
      ...
      const result: ApiResponse<DependencyAnalysisResponse> =
        await response.json();
  ...
  const sortedDependencies = [...filteredDependencies].sort((a, b) => {
    let aVal: string | number = a[sortBy as keyof DependencyData] as
      | string
      | number;
    let bVal: string | number = b[sortBy as keyof DependencyData] as
      | string
      | number;
      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Comprehensive analysis of project dependencies, versions, and
                    ...
                    <div className='flex items-start justify-between'>
                      <div className='flex-1'>
                        ...
                        <div className='flex items-center gap-4 text-sm text-muted-foreground'>
                          ...
                          <span>
                            Downloads: {formatNumber(dep.weeklyDownloads)}/week
                          </span>
