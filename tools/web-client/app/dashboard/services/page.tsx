...
const UptimeCards = ({ services }: { services: ServiceHealth[] }) => {
  const totalUptime =
    services.length > 0
      ? services.reduce((sum, service) => sum + service.uptime, 0) /
        services.length
      : 0;
      ...
      <Card>
        ...
        <CardContent>
          <div className='text-2xl font-bold'>
            {services.reduce(
              (sum, service) => sum + service.instances.length,
              0
            )}
          </div>
  ...
  return (
    <Card className='mb-6'>
      <CardHeader>
        ...
        <CardDescription>
          Individual service instance health and metrics
        </CardDescription>
      </CardHeader>
      <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Recent service alerts and notifications
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className='rounded-md border'>
