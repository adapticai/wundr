...
app.get('/api/users', authenticateToken, async (req, res) => {
  // Get users logic
    ...
    documentation: "# REST API Template\n\nThis template provides a production-ready REST API...",
    usageStats: { monthly: 1240, total: 15420, trending: true }
  },
  {
    id: "graphql-apollo",
...
export class UserResolver {
  ...
  async createUser(@Arg("data") userData: CreateUserInput): Promise<User> {
    ...
    documentation: "# GraphQL Apollo Template\n\nModern GraphQL implementation...",
    usageStats: { monthly: 680, total: 8750, trending: false }
  },
  {
...
server.get('/health', async (request, reply) => {
  return { status: 'healthy', timestamp: new Date().toISOString() };
    ...
    documentation: "# Fastify Microservice Template\n\nOptimized for performance...",
    usageStats: { monthly: 950, total: 12300, trending: true }
  },
  {
    id: "serverless-lambda",
    name: "Serverless Lambda Functions",
    description: "AWS Lambda functions with API Gateway integration and local development setup",
    category: "Serverless",
    language: "TypeScript",
    ...
    features: ["Local Development", "API Gateway Integration", "Environment Management"],
  ...
  try {
    ...
    documentation: "# Serverless Lambda Template\n\nAWS Lambda functions made easy...",
    usageStats: { monthly: 1800, total: 20100, trending: false }
  },
  {
    id: "websocket-service",
    name: "WebSocket Real-time Service",
    description: "Real-time communication service with WebSocket support and room management",
    category: "Real-time",
    language: "TypeScript",
    framework: "Socket.io",
    difficulty: "intermediate",
    ...
    features: ["Room Management", "Event Broadcasting", "Redis Adapter", "Authentication"],
  ...
  socket.on('message', (data) => {
    ...
    usageStats: { monthly: 420, total: 6800, trending: true }
  }
];
...
export default function ServiceTemplatesPage() {
  ...
  const handleCustomize = (template: ServiceTemplate) => {
    setSelectedTemplate(template);
    setShowCustomizer(true);
  };

  const handleGenerateCode = (template: ServiceTemplate, customizations: any) => {
