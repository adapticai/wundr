...
export default function QualityDashboard() {
    ...
    ? [
        {
          ...
          threshold: 80,
          status:
            latest.testCoverage >= 80
              ? 'pass'
              : latest.testCoverage >= 64
                ? 'warning'
                : 'fail',
        ...
        },
        {
          ...
          threshold: 75,
          status:
            latest.maintainabilityIndex >= 75
              ? 'pass'
              : latest.maintainabilityIndex >= 60
                ? 'warning'
                : 'fail',
          trend: 'stable',
        },
        {
          ...
          threshold: 70,
          status:
            latest.codeComplexity <= 6
              ? 'pass'
              : latest.codeComplexity <= 8
                ? 'warning'
                : 'fail',
          trend:
        ...
        },
        {
          ...
          threshold: 80,
          status:
            latest.technicalDebt <= 20
              ? 'pass'
              : latest.technicalDebt <= 40
                ? 'warning'
                : 'fail',
          trend:
            trends.debt === 'improving'
              ? 'improving'
              : trends.debt === 'declining'
                ? 'declining'
                : 'stable',
        },
        {
          ...
          threshold: 95,
          status:
            latest.duplicateLines <= 50
              ? 'pass'
              : latest.duplicateLines <= 100
                ? 'warning'
                : 'fail',
          trend: 'stable',
        },
  ...
  const coverageData = {
    ...
    datasets: [
      {
        data: latest
          ? [latest.testCoverage, 100 - latest.testCoverage]
          : [0, 100],
            ...
            <div className='grid grid-cols-3 gap-8'>
              <div className='text-center'>
                <p className='text-2xl font-bold text-green-600'>
                  {qualityGates.filter(g => g.status === 'pass').length}
                </p>
                <p className='text-sm text-muted-foreground'>Gates Passed</p>
              </div>
              <div className='text-center'>
                <p className='text-2xl font-bold text-yellow-600'>
                  {qualityGates.filter(g => g.status === 'warning').length}
                </p>
                <p className='text-sm text-muted-foreground'>Warnings</p>
              </div>
              <div className='text-center'>
                <p className='text-2xl font-bold text-red-600'>
                  {qualityGates.filter(g => g.status === 'fail').length}
                </p>
        ...
        <TabsContent value='detailed' className='space-y-6'>
          <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
            <Card>
              ...
              <CardContent>
                <p className='text-2xl font-bold'>
                  {latest?.linesOfCode?.toLocaleString() || 0}
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-2xl font-bold'>
                  {latest?.codeComplexity?.toFixed(1) || 0}
                </p>
                <p className='text-sm text-muted-foreground'>
                  Average per file
                </p>
                ...
                <div className='grid gap-2'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-mono'>
                      {latest.testCoverage.toFixed(1)}%
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span>Maintainability Index:</span>
                    <span className='font-mono'>
                      {latest.maintainabilityIndex.toFixed(1)}%
                    </span>
                  </div>
                  <div className='flex justify-between'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='font-mono'>
                      {latest.technicalDebt.toFixed(1)} hours
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span>Code Complexity:</span>
                    <span className='font-mono'>
                      {latest.codeComplexity.toFixed(1)}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span>Security Issues:</span>
                    <span className='font-mono'>
                      {latest.vulnerabilityCount}
                    </span>
                  </div>
                </div>
              </CardContent>
