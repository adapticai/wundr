...
const features = [
  {
    ...
    description:
      'Analyze large monorepos in seconds with our optimized scanning engine',
  },
  {
    icon: Shield,
    title: 'Intelligent Detection',
    description:
      'Advanced algorithms detect code patterns, duplicates, and refactoring opportunities',
  },
  {
    icon: Globe,
    title: 'Universal Support',
    description:
      'Works with any programming language and framework in your monorepo',
  },
  {
    icon: Sparkles,
    title: 'AI-Powered Insights',
    description:
      'Get smart recommendations powered by machine learning and best practices',
  },
];
  ...
  return (
    <div className='flex flex-1 flex-col gap-6 p-4'>
      <div className='text-center max-w-3xl mx-auto'>
        ...
        <h1 className='text-4xl font-bold mb-4'>Welcome to Wundr</h1>
      ...
      <Card className='max-w-3xl mx-auto w-full bg-gradient-to-br from-purple-500/5 to-blue-600/5 border-purple-200'>
        <CardHeader>
          <CardTitle>Why Wundr?</CardTitle>
        </CardHeader>
        <CardContent className='space-y-4'>
          <p className='text-muted-foreground'>
            Managing a monorepo is complex. As your codebase grows, maintaining
            consistency, preventing duplication, and ensuring clean architecture
            becomes increasingly challenging.
          </p>
          <p className='text-muted-foreground'>
            Wundr provides the insights and tools you need to keep your monorepo
            healthy, performant, and maintainable. Our intelligent analysis
            helps you make informed decisions about refactoring, consolidation,
