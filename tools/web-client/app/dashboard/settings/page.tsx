...
import {
  ...
  ConfigUrlInput,
  ConfigPasswordInput,
} from '@/components/config/config-input';
import {
  ConfigSelect,
  ConfigThemeSelect,
  ConfigAnalysisDepthSelect,
} from '@/components/config/config-select';
      ...
      <div className='space-y-6'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <ConfigNumberInput
            ...
            onChange={value =>
              updateConfig({ duplicateThreshold: parseFloat(value) || 0 })
            }
            min={0}
            max={1}
            step={0.01}
          ...
          <ConfigNumberInput
            ...
            onChange={value =>
              updateConfig({ complexityThreshold: parseInt(value) || 0 })
            }
            min={1}
            max={100}
          ...
          <ConfigNumberInput
            ...
            onChange={value =>
              updateConfig({ minFileSize: parseInt(value) || 0 })
            }
            min={0}
          ...
          <ConfigAnalysisDepthSelect
            ...
            onChange={value =>
              updateConfig({
                analysisDepth: value as 'shallow' | 'medium' | 'deep',
              })
            }
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (!patterns.includes(pattern)) {
                      updateConfig({
                        patternsToIgnore: [...patterns, pattern],
                      });
                    }
                  }}
      ...
      <div className='space-y-6'>
        ...
        <div>
          ...
          <Alert className='mb-4'>
            ...
            <AlertDescription>
              API keys are stored securely and encrypted. They are only used for
...
function ExportSettings() {
  ...
  const formatOptions = [
    ...
    },
    {
      value: 'pdf',
      label: 'PDF',
      description: 'Portable Document Format for presentations',
    },
    {
      value: 'xml',
      label: 'XML',
    ...
    },
    {
      value: 'xlsx',
      label: 'Excel',
      description: 'Microsoft Excel format for detailed analysis',
    },
  ];
      ...
      <div className='space-y-6'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <ConfigNumberInput
            ...
            onChange={value =>
              updateConfig({ maxFileSize: parseInt(value) || 0 })
            }
            min={1}
            max={1000}
        ...
        <div>
                ...
                <CardContent className='p-4'>
                  <div className='flex items-start space-x-3'>
                    <input
                      ...
                      checked={(config.defaultFormats || []).includes(
                        format.value as any
                      )}
                      onChange={e => {
                        const formats = e.target.checked
                          ...
                          : (config.defaultFormats || []).filter(
                              (f: any) => f !== format.value
                            );
          ...
          <p className='text-sm text-muted-foreground mt-4'>
            ...
            You can always choose different formats during export.
          </p>
        </div>
      </div>
    </ConfigSection>
...
function ConfigurationManagement() {
  const { exportConfig, importConfig, save, isDirty, resetAll, updateConfig } =
    useConfig();
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Select a configuration file to import. This will replace
    ...
    <div className='container mx-auto p-6 max-w-6xl'>
      <div className='mb-8'>
        ...
        <p className='text-muted-foreground'>
          Configure your dashboard preferences, analysis settings, and
          integrations
        </p>
      </div>
