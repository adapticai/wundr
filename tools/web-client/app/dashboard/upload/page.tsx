        ...
        {uploads.length > 0 && (
          <div className='flex items-center space-x-4'>
            <div className='text-sm text-muted-foreground'>
              {stats.total} files • {stats.completed} completed •{' '}
              {stats.uploading + stats.processing} in progress
            </div>
      ...
      <Tabs defaultValue='upload' className='space-y-4'>
        <TabsList>
          ...
          <TabsTrigger value='history'>
            Upload History ({recentUploads.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value='upload' className='space-y-4'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Drag and drop files or click to browse. Supports JSON and CSV
              ...
              {uploads.length >= MAX_FILES && (
                <div className='mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md'>
                  <p className='text-sm text-yellow-700 dark:text-yellow-300'>
                    Maximum file limit reached ({MAX_FILES}). Please remove some
                    files before uploading more.
                  </p>
                </div>
              )}
            </CardContent>
