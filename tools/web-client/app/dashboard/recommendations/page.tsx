...
export default function RecommendationsPage() {
  ...
  const filteredRecommendations = useMemo(() => {
    ...
    return filtered.sort((a, b) => {
      switch (sortBy) {
        ...
        case 'effort':
          return (
            parseEffort(a.estimatedEffort) - parseEffort(b.estimatedEffort)
          );
        case 'impact':
  ...
  const stats = useMemo(() => {
    ...
    const autoFixAvailable = recommendations.filter(
      r => r.autoFixAvailable
    ).length;
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              {stats.byPriority.critical} critical, {stats.byPriority.high} high
              priority
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold text-green-600'>
              {realtimeUpdates?.data?.autoFixAvailable ||
                stats.autoFixAvailable}
            </div>
            <p className='text-xs text-muted-foreground'>
        ...
        <div className='flex flex-wrap gap-4 items-center'>
          <div className='flex items-center gap-2'>
            ...
            <Select
              value={sortBy}
              onValueChange={(
                value: 'priority' | 'effort' | 'impact' | 'status'
              ) => setSortBy(value)}
            >
          ...
          <div className='flex items-center gap-2'>
            ...
            <Select
              ...
              onValueChange={setFilterByPriority}
            >
              <SelectTrigger className='w-32'>
      ...
      <Tabs defaultValue='all' className='w-full'>
        <TabsList className='grid w-full grid-cols-5'>
          ...
          <TabsTrigger value='critical'>
            Critical (
            {
              filteredRecommendations.filter(r => r.priority === 'critical')
                .length
            }
            )
          </TabsTrigger>
    ...
    <Card className='relative'>
      <CardHeader>
        <div className='flex items-start justify-between'>
          ...
          <div
            className={`px-2 py-1 rounded-md text-xs font-medium border ${getStatusColor(recommendation.status)}`}
          >
