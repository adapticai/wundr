    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground mt-2'>
            Comprehensive analytics and insights for your codebase with
            real-time updates
          </p>
        </div>
      ...
      {errors.length > 0 && (
        <Alert variant='destructive'>
          ...
          <AlertDescription>
            {errors.length} visualization error{errors.length > 1 ? 's' : ''}{' '}
            detected. Some charts may not display correctly.
            <Button
              variant='link'
      ...
      <div className='grid gap-4 md:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Update mechanism</p>
          </CardContent>
        </Card>
            ...
            <CardContent>
              {perfError ? (
                ...
                <Suspense fallback={<PerformanceMetricsSkeleton />}>
                  <LazyPerformanceMetrics data={perfData || []} />
                </Suspense>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent>
              {qualityError ? (
                ...
                <Suspense fallback={<QualityMetricsSkeleton />}>
                  <LazyCodeQualityRadar
                    metrics={
                      qualityData?.[qualityData.length - 1] || {
                        maintainability: 0,
                        reliability: 0,
                        security: 0,
                        coverage: 0,
          ...
          <Card>
            <CardHeader className='flex flex-row items-center justify-between'>
              <div>
                ...
                <CardDescription>
                  Interactive visualization of module dependencies and
                  relationships
                </CardDescription>
              </div>
              <div className='flex gap-2'>
            ...
            <CardContent>
              {analysisData?.dependencies ? (
                <Suspense fallback={<DependencyNetworkSkeleton />}>
                  <LazyDependencyNetwork
                    nodes={(analysisData.dependencies.nodes || []).map(
                      (node: any) => ({
                        ...node,
                    ...
                    links={(analysisData.dependencies.edges || []).map(
                      (edge: any) => ({
                        ...edge,
                ...
                <div className='text-center py-12'>
                  ...
                  <p className='text-muted-foreground mb-4'>
                    Run an analysis to view dependency relationships
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <CardContent>
              <div className='text-center py-12'>
                ...
                <p className='text-muted-foreground'>
                  Historical trends and pattern analysis across all metrics
                </p>
              </div>
            </CardContent>
          </Card>
