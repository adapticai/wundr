    ...
    <Card>
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='grid gap-2'>
          <div
            className={`p-2 rounded ${isMobile ? 'bg-blue-100' : 'bg-gray-100'}`}
          >
            Mobile: {isMobile ? 'Yes' : 'No'}
          </div>
          <div
            className={`p-2 rounded ${isTablet ? 'bg-green-100' : 'bg-gray-100'}`}
          >
            Tablet: {isTablet ? 'Yes' : 'No'}
          </div>
          <div
            className={`p-2 rounded ${isDesktop ? 'bg-purple-100' : 'bg-gray-100'}`}
          >
    ...
    <>
      ...
      >
        <div className='space-y-4'>
          <p>
            This is a responsive modal that automatically switches between a
            drawer on mobile and a dialog on desktop.
          </p>
      ...
      <CardContent className='space-y-4'>
        ...
        {isDesktop ? (
          <div className='p-4 bg-blue-50 rounded-lg'>
            Desktop View (using hook)
          </div>
        ) : (
          <div className='p-4 bg-green-50 rounded-lg'>
            Mobile View (using hook)
          </div>
        )}
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='space-y-2'>
          ...
          <div className='flex gap-2'>
            <button className='h-11 w-11 bg-primary text-white rounded-lg'>
              A
            </button>
            <button className='h-11 w-11 bg-primary text-white rounded-lg'>
              B
        ...
        <p className='text-sm text-muted-foreground'>
          Larger buttons on mobile for easier touch, smaller on desktop for
          mouse precision
        </p>
      </CardContent>
    </Card>
        ...
        <CardContent className='space-y-4'>
          <div>
            ...
            <ul className='list-disc list-inside space-y-1 text-sm'>
              <li>
                Press Ctrl+Shift+M (or Cmd+Shift+M on Mac) to toggle device
                toolbar
              </li>
          ...
          <div>
            ...
            <ul className='list-disc list-inside space-y-1 text-sm'>
              ...
              <li>
                /components/ui/responsive-modal.tsx - Responsive modal/drawer
              </li>
