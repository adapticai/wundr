...
The `/dashboard/load-report` page provides comprehensive functionality for loading, viewing, and
analyzing code analysis reports in the Wundr dashboard.
...
- **Summary Statistics**: Total files, entities, duplicates, circular dependencies, unused exports,
  code smells
