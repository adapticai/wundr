    ...
    <div className="flex flex-1 flex-col gap-4 p-4">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Everything you need to know about Wundr.io - Intelligent Monorepo Analysis by Lumic.ai
        </p>
      </div>
      ...
      <Card className="mt-4">
        ...
        <CardContent>
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/dashboard/analysis/duplicates" className="text-primary hover:underline">
                → Check for Duplicate Code
              </Link>
            </li>
            <li>
              <Link href="/dashboard/recommendations" className="text-primary hover:underline">
