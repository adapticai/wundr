...
- **Migrate existing project** → [Migration Guide](./guides/MIGRATION.md)
- **Configure agents** → [Agent Configuration](./guides/AGENT_CONFIGURATION.md)
...
│  • SPARC Workflows      • Neural Training               │
└─────────────────────────────────────────────────────────┘
```
...
1. **User Request** → Claude Code receives task
2. **Coordination** → MCP tools initialize swarm
3. **Planning** → SPARC coordinator creates plan
4. **Execution** → Agents work via Claude Code
5. **Automation** → Hooks run pre/post operations
6. **Learning** → Neural patterns trained
7. **Completion** → Results stored in memory
...
**Guides**: [Quick Start](./guides/QUICK_START.md) → [API Reference](./reference/API.md)
...
1. ✅ Complete [Quick Start Guide](./guides/QUICK_START.md)
2. ✅ Build your first feature with SPARC TDD
3. ✅ Explore [Agent Configuration](./guides/AGENT_CONFIGURATION.md)
...
1. ✅ Create custom agents: [Agent Configuration](./guides/AGENT_CONFIGURATION.md)
2. ✅ Build automation: [Hook Development](./guides/HOOK_DEVELOPMENT.md)
3. ✅ Master worktrees: [Git-Worktree Guide](./guides/GIT_WORKTREE.md)
4. ✅ Reference: [API Documentation](./reference/API.md)

## 📝 Summary

This documentation provides:

- ✅ **8 Comprehensive Guides**: From basics to advanced
- ✅ **Complete API Reference**: All commands and tools
- ✅ **Real-World Examples**: Practical workflows
