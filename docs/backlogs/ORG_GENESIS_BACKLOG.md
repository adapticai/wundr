...
This backlog defines the systematic implementation of the `@wundr/org-genesis` package, which provides:
...
- [ ] `src/context-compiler/config-generator.ts` - Generate CLAUDE.md, claude_config.json, settings.json
