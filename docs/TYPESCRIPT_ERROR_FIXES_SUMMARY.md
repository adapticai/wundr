...
Successfully reduced TypeScript errors from **242 errors** across **45 files** to a significantly
lower count.
...
- `generateReportMarkdown`, `parseReportMarkdown`, `extractReportStats`, `generateReportTOC` to
  `markdown-utils.ts`
