/**
 * VP Test Data Factories
 *
 * Factory functions for creating consistent mock VP data in tests.
 * These factories provide sensible defaults while allowing overrides
 * for specific test scenarios.
 *
 * @module @genesis/core/test-utils/vp-factories
 */
...
/**
 * Create mock VP charter
 */
export function createMockVPCharter(overrides?: Partial<VPCharter>): VPCharter {
  return {
...
/**
 * Mock VP data matching Prisma VP model
 */
...
export interface MockUser {
  ...
  isVP: boolean;
  vpConfig: VPServiceAccountConfig | null;
...
/**
 * Mock VPWithUser combining VP and User data
 */
export interface MockVPWithUser extends MockVP {
  user: MockUser;
}

/**
 * Create a mock VP entity (Prisma model format)
 */
export function createMockVP(overrides?: Partial<MockVP>): MockVP {
...
export function createMockUser(overrides?: Partial<MockUser>): MockUser {
  ...
  return {
    ...
    bio: 'A test VP for automated testing',
    status: 'ACTIVE',
    isVP: true,
    vpConfig: {
...
/**
 * Create a mock VP with user data
 */
...
/**
 * Create multiple mock VPs with users
 */
...
export function createMockPrismaClient(): MockPrismaClient {
  const mockVPs: MockVPWithUser[] = [];
  const mockUsers: MockUser[] = [];
  const mockOrgs: MockOrganization[] = [];

  return {
    // Mock data stores for assertions
    _mockData: { vps: mockVPs, users: mockUsers, organizations: mockOrgs },
...
export const VPFactories = {
  vp: createMockVP,
  user: createMockUser,
  vpWithUser: createMockVPWithUser,
