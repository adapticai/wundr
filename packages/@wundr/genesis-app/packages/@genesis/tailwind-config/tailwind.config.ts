...
/**
 * Genesis-App Tailwind Configuration
 *
 * This configuration provides a cohesive design system for the Genesis-App,
 * including brand colors, dark mode support, chat UI components, and animations.
 */
const config: Config = {
  content: [
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        input: '0 0 0 2px rgb(12 140 233 / 0.2)',
