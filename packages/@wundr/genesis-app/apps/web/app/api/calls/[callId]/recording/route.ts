...
export async function POST(
  ...
  try {
    ...
    const { format, audioOnly, outputPath } = parseResult.data;
    ...
    console.log('[POST /api/calls/:callId/recording] Starting recording:', {
...
export async function DELETE(
  ...
  try {
    ...
    console.log('[DELETE /api/calls/:callId/recording] Stopping recording:', {
      callId: params.callId,
