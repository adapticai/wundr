...
interface CreateVPDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate: (input: CreateVPInput) => Promise<void>;
  isLoading?: boolean;
}
...
export function CreateVPDialog({ isOpen, onClose, onCreate, isLoading = false }: CreateVPDialogProps) {
...
return null;
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="create-vp-title"
    >
      <div
      ...
      >
        ...
        <div className="border-b px-6 py-4">
          <div className="flex items-center justify-between">
            <h2 id="create-vp-title" className="text-lg font-semibold text-foreground">
              Create New VP
            </h2>
            <button
              type="button"
        ...
        <div className="max-h-[60vh] overflow-y-auto px-6 py-6">
          ...
          {currentStep === 'basic' && (
            <div className="space-y-4">
              <div>
                <label htmlFor="vp-title" className="mb-1 block text-sm font-medium text-foreground">
                  VP Name <span className="text-red-500">*</span>
                </label>
                <input
                  id="vp-title"
                  type="text"
              ...
              <div>
                <label htmlFor="vp-discipline" className="mb-1 block text-sm font-medium text-foreground">
              ...
              <div>
                <label htmlFor="vp-description" className="mb-1 block text-sm font-medium text-foreground">
                  Description
                </label>
                <textarea
                  id="vp-description"
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe how this VP should communicate..."
                  rows={2}
                  className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                  disabled={isLoading}
                />
          ...
          {currentStep === 'operational' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-muted-foreground">
                  The expected time for this VP to respond to messages.
                </p>
              </div>
            </div>
          )}
          ...
          {currentStep === 'review' && (
            <div className="space-y-6">
              <h3 className="text-sm font-medium text-foreground">Review Your VP Configuration</h3>
