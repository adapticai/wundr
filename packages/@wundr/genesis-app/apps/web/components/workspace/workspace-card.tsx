...
export function WorkspaceCard({ workspace, onClick }: WorkspaceCardProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex flex-col items-start rounded-lg border bg-card p-6 text-left shadow-sm transition-all hover:border-primary hover:shadow-md"
    >
      {/* Workspace Icon */}
      ...
      {/* Stats */}
      <div className="mt-auto flex w-full gap-4 pt-4 text-sm text-muted-foreground">
