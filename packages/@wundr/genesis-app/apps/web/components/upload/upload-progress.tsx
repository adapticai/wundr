...
export function UploadProgress({ upload, onCancel, onRetry, className }: UploadProgressProps) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 text-xs text-muted-foreground">{formatFileSize(upload.size)}</p>
        ...
        {(isUploading || isPending) && (
          <div className="mt-2">
            ...
            <p className="mt-1 text-xs text-muted-foreground">{Math.round(upload.progress)}%</p>
          </div>
        )}
        ...
        {/* Cancelled State */}
        {isCancelled && <p className="mt-1 text-xs text-muted-foreground">Upload cancelled</p>}
      </div>
