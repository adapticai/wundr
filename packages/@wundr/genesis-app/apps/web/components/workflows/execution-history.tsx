    ...
    <div className={cn('space-y-4', className)}>
      ...
      {filteredExecutions.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed bg-muted/30 py-12">
          ...
          <h3 className="mt-4 text-lg font-semibold text-foreground">No executions found</h3>
          ...
          <div className="space-y-4">
            {filteredExecutions.map((execution) => (
              <ExecutionItem
                ...
                onViewDetails={onViewDetails ? () => onViewDetails(execution) : undefined}
              />
            ))}
          </div>
        </div>
        ...
        {isExpanded && (
          <div className="border-t px-4 py-4">
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-foreground">Action Results</p>
              {execution.actionResults.map((result, index) => (
                <ActionResultItem key={result.actionId} result={result} index={index} />
              ))}
            </div>
            ...
            {execution.triggerData && (
              <div className="mt-4">
                <p className="text-sm font-medium text-foreground">Trigger Data</p>
...
function ExecutionStatusBadge({ status, className }: ExecutionStatusBadgeProps) {
