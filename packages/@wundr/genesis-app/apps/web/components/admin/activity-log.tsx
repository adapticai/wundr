...
const ACTION_TYPE_CONFIG = {
  create: { color: 'bg-green-500', icon: PlusIcon },
  update: { color: 'bg-blue-500', icon: EditIcon },
  delete: { color: 'bg-red-500', icon: TrashIcon },
  access: { color: 'bg-purple-500', icon: EyeIcon },
  security: { color: 'bg-yellow-500', icon: ShieldIcon },
    ...
    <div className={cn('space-y-4', className)}>
      ...
      <div className="flex flex-wrap items-center gap-4">
        <select
          ...
          onChange={(e) => {
            setFilters((f) => ({ ...f, actionType: e.target.value || undefined }));
            setPage(0);
          }}
        ...
        <select
          ...
          onChange={(e) => {
            setFilters((f) => ({ ...f, resourceType: e.target.value || undefined }));
            setPage(0);
          }}
          className="px-3 py-2 rounded-lg bg-muted border border-border text-foreground"
        >
          ...
          <option value="vp">Virtual Personas</option>
