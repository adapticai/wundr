...
export function ParticipantTile({
  ...
  const isMuted = !microphoneTrack?.publication ||
  ...
  return (
    ...
    >
      ...
      {microphoneTrack && microphoneTrack.publication && !isLocal && (
        <AudioTrack trackRef={microphoneTrack as TrackReferenceOrPlaceholder & { publication: NonNullable<TrackReferenceOrPlaceholder['publication']> }} />
      )}
