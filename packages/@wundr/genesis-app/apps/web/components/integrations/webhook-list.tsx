      ...
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center gap-4 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <h4 className="truncate font-medium text-foreground">{webhook.name}</h4>
            <p className="truncate text-sm text-muted-foreground font-mono">{maskedUrl}</p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-sm text-foreground">
                ...
                {webhook.retryPolicy.exponentialBackoff && ' with exponential backoff'}
              </p>
            </div>
          </div>
        </div>
