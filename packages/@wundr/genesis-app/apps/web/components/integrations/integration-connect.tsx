...
const DEFAULT_POPULAR: IntegrationProvider[] = ['slack', 'github', 'notion', 'jira', 'linear'];
...
export function IntegrationConnect({
  ...
  const [connectMethod, setConnectMethod] = useState<'oauth' | 'apikey'>('oauth');
  const [apiKey, setApiKey] = useState('');
  const [integrationName, setIntegrationName] = useState('');
  const [isConnecting, setIsConnecting] = useState(false);
  const [error, setError] = useState<string | null>(null);

  const allProviders = Object.entries(INTEGRATION_PROVIDERS) as [IntegrationProvider, typeof INTEGRATION_PROVIDERS[IntegrationProvider]][];
...
return;
  ...
  }, [selectedProvider, integrationName, connectMethod, apiKey, onConnect, onClose]);
      ...
      >
        ...
        <div className="flex items-center justify-between border-b px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <h2 id="connect-dialog-title" className="text-lg font-semibold text-foreground">
              {selectedProvider
        ...
        <div className="max-h-[60vh] overflow-y-auto p-6">
          {!selectedProvider ? (
            <>
              ...
              {!searchQuery.trim() && (
                <div className="mb-6">
                  <h3 className="mb-3 text-sm font-medium text-muted-foreground">Popular</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 rounded-lg bg-muted/50 p-4">
                <ProviderIcon provider={selectedProvider} className="h-12 w-12" />
                <div>
              ...
              {/* Integration Name */}
              <div>
                <label htmlFor="integration-name" className="block text-sm font-medium text-foreground">
                  Integration Name
                </label>
                <input
                  id="integration-name"
              ...
              {/* Permissions Display */}
              <div>
                <h4 className="text-sm font-medium text-foreground">Requested Permissions</h4>
        ...
        {selectedProvider && (
          <div className="flex items-center justify-end gap-3 border-t px-6 py-4">
            ...
            <button
              ...
              disabled={isConnecting || (connectMethod === 'apikey' && !apiKey.trim())}
