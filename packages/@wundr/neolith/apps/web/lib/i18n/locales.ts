...
export const LOCALES: Locale[] = [
  // English
  { code: 'en-US', name: 'English (US)', nativeName: 'English (United States)', region: 'Americas' },
  { code: 'en-GB', name: 'English (UK)', nativeName: 'English (United Kingdom)', region: 'Europe' },
  ...
  { code: 'es-AR', name: 'Spanish (Argentina)', nativeName: 'Español (Argentina)', region: 'Americas' },
  ...
  { code: 'de-CH', name: 'German (Switzerland)', nativeName: 'Deutsch (Schweiz)', region: 'Europe' },
  ...
  // Arabic
  { code: 'ar-SA', name: 'Arabic (Saudi Arabia)', nativeName: 'العربية (السعودية)', region: 'Middle East', isRTL: true },
  { code: 'ar-AE', name: 'Arabic (UAE)', nativeName: 'العربية (الإمارات)', region: 'Middle East', isRTL: true },

  // Hebrew
  { code: 'he-IL', name: 'Hebrew', nativeName: 'עברית', region: 'Middle East', isRTL: true },
  ...
  // Vietnamese
  { code: 'vi-VN', name: 'Vietnamese', nativeName: 'Tiếng Việt', region: 'Asia' },

  // Indonesian
  { code: 'id-ID', name: 'Indonesian', nativeName: 'Bahasa Indonesia', region: 'Asia' },
...
export const TIMEZONES: Timezone[] = [
  // Americas
  { value: 'America/New_York', label: 'Eastern Time (US & Canada)', offset: 'UTC-5', region: 'Americas' },
  { value: 'America/Chicago', label: 'Central Time (US & Canada)', offset: 'UTC-6', region: 'Americas' },
  { value: 'America/Denver', label: 'Mountain Time (US & Canada)', offset: 'UTC-7', region: 'Americas' },
  { value: 'America/Los_Angeles', label: 'Pacific Time (US & Canada)', offset: 'UTC-8', region: 'Americas' },
  { value: 'America/Anchorage', label: 'Alaska', offset: 'UTC-9', region: 'Americas' },
  { value: 'Pacific/Honolulu', label: 'Hawaii', offset: 'UTC-10', region: 'Americas' },
  { value: 'America/Phoenix', label: 'Arizona', offset: 'UTC-7', region: 'Americas' },
  ...
  { value: 'Asia/Kolkata', label: 'Mumbai, Kolkata, New Delhi', offset: 'UTC+5:30', region: 'Asia' },
  { value: 'Asia/Bangkok', label: 'Bangkok, Hanoi, Jakarta', offset: 'UTC+7', region: 'Asia' },
  ...
  // Oceania
  { value: 'Australia/Sydney', label: 'Sydney, Melbourne', offset: 'UTC+11', region: 'Oceania' },
  ...
  { value: 'Pacific/Auckland', label: 'Auckland', offset: 'UTC+13', region: 'Oceania' },
  ...
  { value: 'Asia/Jerusalem', label: 'Jerusalem', offset: 'UTC+2', region: 'Middle East' },
  { value: 'Asia/Riyadh', label: 'Riyadh', offset: 'UTC+3', region: 'Middle East' },
];
...
export const NUMBER_FORMATS = [
  { value: 'en-US', label: '1,234.56 (US)', example: '1,234.56', decimal: '.', thousands: ',' },
  { value: 'de-DE', label: '1.234,56 (EU)', example: '1.234,56', decimal: ',', thousands: '.' },
  { value: 'fr-FR', label: '1 234,56 (FR)', example: '1 234,56', decimal: ',', thousands: ' ' },
  { value: 'en-IN', label: '1,23,456.78 (IN)', example: '1,23,456.78', decimal: '.', thousands: ',' },
];

export const CURRENCY_FORMATS = [
  { value: 'symbol-before', label: '$100.00', description: 'Symbol before amount' },
  { value: 'symbol-after', label: '100.00$', description: 'Symbol after amount' },
  { value: 'code-before', label: 'USD 100.00', description: 'Code before amount' },
  { value: 'code-after', label: '100.00 USD', description: 'Code after amount' },
];
...
export function getLocaleRegions(): string[] {
  return Array.from(new Set(LOCALES.map(l => l.region).filter(Boolean))) as string[];
}
