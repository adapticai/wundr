  ...
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <ChannelSectionSkeleton title="Direct Messages" itemCount={4} showAction />
      </div>
    </div>
  );
}
...
function ChannelSectionSkeleton({ title: _title, itemCount, showAction }: ChannelSectionSkeletonProps) {
  return (
    <div className="py-1">
      {/* Section Header */}
