    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="truncate font-semibold text-foreground font-heading">{vp.title}</h3>
          {vp.discipline && (
            <p className="truncate text-sm text-muted-foreground font-sans">{vp.discipline}</p>
          )}
        </div>
      </div>
        ...
        <div className={cn('flex items-center gap-1 text-xs font-sans', connectionConfig.color)}>
          <span
            className={cn(
              ...
              vp.connectionStatus === 'connected' && 'bg-emerald-500',
              vp.connectionStatus === 'disconnected' && 'bg-rose-500',
              vp.connectionStatus === 'connecting' && 'bg-amber-500 animate-pulse',
            )}
          />
