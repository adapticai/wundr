...
export function IntegrationSettings({
  ...
  const [activeTab, setActiveTab] = useState<
    'general' | 'channels' | 'notifications' | 'danger'
  >('general');
    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center'>
      ...
      >
        ...
        <div className='flex border-b px-6'>
          {(['general', 'channels', 'notifications', 'danger'] as const).map(
            tab => (
              <button
                key={tab}
                type='button'
        ...
        <div className='max-h-[50vh] overflow-y-auto p-6'>
          ...
          {activeTab === 'channels' && (
            <div className='space-y-4'>
              <p className='text-sm text-muted-foreground'>
                Configure channel mappings between this integration and your
                workspace.
              </p>
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    {[
                      ...
                      {
                        type: 'orchestrator.message' as const,
                        label: 'Orchestrator Messages',
                      },
                      {
                      ...
                      {
                        type: 'workflow.triggered' as const,
            ...
            <div className='space-y-4'>
              <div className='rounded-lg border border-red-500/20 bg-red-500/5 p-4'>
                ...
                <p className='mt-1 text-sm text-muted-foreground'>
                  Once you disconnect this integration, you will need to
                  reconnect and reconfigure it.
                </p>
          ...
          {/* Error Message */}
          {error && (
            <div className='mt-4 rounded-md bg-red-500/10 p-3 text-sm text-red-600'>
              {error}
            </div>
          )}
        </div>
