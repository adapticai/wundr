            ...
            <div className="min-w-0 flex-1">
              <p
                className={cn(
                  ...
                  !notification.read ? 'font-semibold text-stone-900 dark:text-stone-100' : 'text-stone-700 dark:text-stone-300',
                )}
              >
                {notification.title}
              </p>
              <p className="mt-0.5 text-sm text-stone-600 dark:text-stone-400 line-clamp-2 font-sans">
                {notification.body}
              </p>
            </div>
