...
const validateConfig = (config: BudgetConfiguration): { valid: boolean; errors: string[] } => {
  const errors: string[] = [];
...
export function BudgetSettings({
  ...
  const [localConfig, setLocalConfig] = React.useState<BudgetConfiguration>(config);
  ...
  const updateConfig = (key: keyof BudgetConfiguration, value: number | boolean) => {
        ...
        <div className="space-y-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateConfig('hourlyLimit', Number(e.target.value))}
                />
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateConfig('dailyLimit', Number(e.target.value))}
                />
                <p className="text-xs text-muted-foreground">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateConfig('monthlyLimit', Number(e.target.value))}
                />
                <p className="text-xs text-muted-foreground">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateConfig('autoPauseEnabled', checked)}
            />
          </div>
        </div>
