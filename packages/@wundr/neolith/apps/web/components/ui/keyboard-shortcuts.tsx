...
const shortcuts: Shortcut[] = [
  ...
  {
    keys: ['Cmd', '3'],
    description: 'Go to Virtual People',
    category: 'Navigation',
  },
  {
    keys: ['Cmd', '4'],
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className='max-w-2xl max-h-[80vh] overflow-y-auto'>
        <DialogHeader>
          ...
          <DialogDescription>
            Press <kbd className='px-2 py-1 text-xs bg-muted rounded'>?</kbd> to
            toggle this dialog
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='mt-6 pt-4 border-t text-xs text-muted-foreground'>
          <p>
            ...
            <kbd className='px-1.5 py-0.5 bg-muted rounded'>Ctrl</kbd> instead
            of <kbd className='px-1.5 py-0.5 bg-muted rounded'>Cmd</kbd>
          </p>
        </div>
      </DialogContent>
    </Dialog>
