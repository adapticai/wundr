...
export function OrchestratorWorkSummary({
  orchestrator,
  stats,
  workspaceId,
  className,
}: OrchestratorWorkSummaryProps) {
  const totalTimeToday = stats.activeTimeToday + stats.idleTimeToday;
  const activePercentage =
    totalTimeToday > 0
      ? Math.round((stats.activeTimeToday / totalTimeToday) * 100)
      : 0;
        ...
        <div className='flex items-start justify-between'>
          <div>
            <CardTitle className='text-lg'>
              {orchestrator.title} Work Summary
            </CardTitle>
            <CardDescription>
          ...
          <div className='space-y-2'>
            ...
            <div className='flex items-center justify-between text-sm'>
              ...
              <span className='font-medium'>
                {formatMinutes(stats.activeTimeToday)}
              </span>
            </div>
            ...
            <div className='flex items-center justify-between text-sm'>
              ...
              <span className='font-medium'>
                {formatMinutes(stats.idleTimeToday)}
              </span>
            </div>
