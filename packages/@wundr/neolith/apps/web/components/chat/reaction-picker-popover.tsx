...
/**
 * Props for the ReactionPickerPopover component
 */
interface ReactionPickerPopoverProps {
  ...
  open?: boolean;
  /** Callback to control the open state externally */
...
/**
 * Compact Reaction Picker in a Popover
 *
 * Optimized for quick emoji selection with:
 * - Quick reactions bar
 * - Category tabs
