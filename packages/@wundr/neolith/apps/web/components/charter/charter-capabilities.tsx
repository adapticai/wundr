...
export function CharterCapabilities({
  ...
  const handlePermissionChange = (capabilityId: string, permissionLevel: PermissionLevel) => {
    onChange(
      value.map((cap) =>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Select
              ...
              onValueChange={(value) => setSelectedCategory(value as CapabilityCategory | 'all')}
              disabled={disabled}
            >
              <SelectTrigger>
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="flex items-start justify-between gap-4">
                                  <div className="flex items-start gap-3 flex-1">
                                    {capDef.icon && (
                                      <div className="text-xl mt-0.5">{capDef.icon}</div>
                                    )}
                                ...
                                {isEnabled && capability && (
                                  <div className="border-t pt-4 space-y-4">
                                    ...
                                    {/* Rate Limiting */}
                                    <div className="space-y-2">
                                      <Label className="text-xs">Rate Limiting (optional)</Label>
                                      <div className="grid gap-3 md:grid-cols-3">
                                        <div className="space-y-1.5">
                                          ...
                                          <Input
                                            ...
                                            type="number"
                                            min="1"
                                            value={capability.rateLimit?.maxPerMinute ?? ''}
                                            onChange={(e) =>
                                        ...
                                        <div className="space-y-1.5">
                                          ...
                                          <Input
                                            ...
                                            type="number"
                                            min="1"
                                            value={capability.rateLimit?.maxPerHour ?? ''}
                                            onChange={(e) =>
                                              handleRateLimitChange(
                                                capDef.id,
                                                'maxPerHour',
                                        ...
                                        <div className="space-y-1.5">
                                          ...
                                          <Input
                                            ...
                                            type="number"
                                            min="1"
                                            value={capability.rateLimit?.maxPerDay ?? ''}
                                            onChange={(e) =>
                                              handleRateLimitChange(
                                                capDef.id,
                                                'maxPerDay',
