...
export function CharterVersionHistory({
  ...
  // Dialog states
  const [activateDialog, setActivateDialog] = React.useState<CharterVersion | null>(null);
  const [rollbackDialog, setRollbackDialog] = React.useState<CharterVersion | null>(null);
                ...
                <TableRow key={version.id}>
                  <TableCell>
                    <Checkbox
                      ...
                      onCheckedChange={() => handleVersionToggle(version.version)}
      ...
      <Dialog open={!!activateDialog} onOpenChange={() => setActivateDialog(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to activate version {activateDialog?.version}?
              This will make it the current active version.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={!!rollbackDialog} onOpenChange={() => setRollbackDialog(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to rollback to version {rollbackDialog?.version}?
