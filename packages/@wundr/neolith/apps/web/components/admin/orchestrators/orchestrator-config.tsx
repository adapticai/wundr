...
export function OrchestratorConfig({
  ...
  const [formData, setFormData] = useState({
    ...
    autoEscalation: orchestrator.charter?.operationalSettings?.autoEscalation ?? false,
    responseTimeTarget: orchestrator.charter?.operationalSettings?.responseTimeTarget ?? 30,
  });
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, responseTimeTarget: parseInt(e.target.value) })
                }
                min={1}
                max={240}
              />
