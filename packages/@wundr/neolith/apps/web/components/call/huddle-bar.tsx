    ...
    >
      ...
      <div className="flex items-center gap-1">
        {speakingParticipants.length > 0 ? (
          <div className="flex items-center gap-0.5 h-4" aria-label="Someone is speaking">
            {[1, 2, 3].map((bar) => (
              <div
                key={bar}
      ...
      {/* Participant count */}
      <span className="text-xs text-muted-foreground">{huddle.participants.length}</span>
  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        <p className="text-sm font-medium text-foreground truncate">{huddle.name}</p>
