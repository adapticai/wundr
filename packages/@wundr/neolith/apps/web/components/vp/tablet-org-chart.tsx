 ...
 * @module components/vp/tablet-org-chart
 *
...
import { useIsTablet, useOrientation, useTouchDevice } from '@/hooks/use-media-query';
    ...
    >
      ...
      {showChildren && (
        <div
          className={cn(
            'flex gap-4',
            layoutDirection === 'horizontal' ? 'flex-col' : 'flex-row flex-wrap',
