...
export function VPCard({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="truncate font-heading font-semibold text-foreground">{vp.title}</h3>
            {vp.discipline && (
              <p className="truncate text-sm font-sans text-muted-foreground">{vp.discipline}</p>
            )}
          </div>
        </div>
      ...
      {/* Description */}
      {vp.description && (
        <p className="mb-4 line-clamp-2 text-sm font-sans text-muted-foreground">{vp.description}</p>
      )}
