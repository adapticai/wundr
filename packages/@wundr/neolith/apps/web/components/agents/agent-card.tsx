...
export function AgentCard({ agent, onEdit, onPause, onResume, onDelete }: AgentCardProps) {
  ...
  return (
    <div className="group relative rounded-lg border border-stone-800 bg-stone-900 p-4 transition-all hover:border-stone-700 hover:bg-stone-900/80">
      ...
      {/* Description */}
      {agent.description && (
        <p className="mb-3 line-clamp-2 text-sm text-stone-400">{agent.description}</p>
      )}
      ...
      <div className="grid grid-cols-3 gap-2 border-t border-stone-800 pt-3">
        <div className="text-center">
          <p className="text-lg font-semibold text-stone-100">{agent.stats.tasksCompleted}</p>
          <p className="text-xs text-stone-500">Tasks</p>
        </div>
        <div className="text-center">
          <p className="text-lg font-semibold text-stone-100">{agent.stats.successRate}%</p>
