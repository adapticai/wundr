    ...
    >
      ...
      >
        ...
        <div className="border-b px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="agent-detail-title" className="text-lg font-semibold text-foreground">
                  {isEditing ? 'Edit Agent' : agent.name}
                </h2>
                <p className="text-sm text-muted-foreground">{metadata.label}</p>
              </div>
            </div>
            <button
              type="button"
        ...
        <div className="h-[calc(100%-140px)] overflow-y-auto px-6 py-6">
          {!isEditing ? (
            <div className="space-y-6">
              ...
              {/* Configuration */}
              <div>
                <h3 className="mb-3 text-sm font-medium text-foreground">Configuration</h3>
                <div className="space-y-2 rounded-lg border border-border bg-background p-4 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Model</span>
                    <span className="font-medium text-foreground">{agent.config.model}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-foreground">{agent.config.maxTokens}</span>
                  </div>
                </div>
              </div>
              ...
              {agent.systemPrompt && (
                <div>
                  <h3 className="mb-2 text-sm font-medium text-foreground">System Prompt</h3>
              ...
              {agent.tools.length > 0 && (
                <div>
                  <h3 className="mb-2 text-sm font-medium text-foreground">Available Tools</h3>
        ...
        <div className="border-t px-6 py-4">
          {showDeleteConfirm ? (
            <div className="flex items-center justify-between">
              <p className="text-sm text-foreground">Are you sure you want to delete this agent?</p>
