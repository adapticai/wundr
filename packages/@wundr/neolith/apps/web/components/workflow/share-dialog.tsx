...
export function ShareDialog({
  ...
  const [defaultPermission, setDefaultPermission] =
    useState<WorkflowPermissionLevel>('view');
        ...
        <div className='space-y-4 py-4'>
                      ...
                      {recipientsList.map(recipient => (
                        ...
                        >
                          ...
                          <Button
                            ...
                            className='h-8 w-8'
                            onClick={() =>
                              handleRemoveRecipient(recipient.entity.id)
                            }
                          >
                            <X className='h-4 w-4' />
                          </Button>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={v =>
                setDefaultPermission(v as WorkflowPermissionLevel)
              }
            >
            ...
            <div className='p-3 bg-muted/50 rounded-lg'>
              <div className='flex items-center gap-2 text-sm text-muted-foreground'>
                ...
                <span>
                  ...
                  {currentShares.length === 1 ? 'person' : 'people'}
                </span>
              </div>
            </div>
          )}
          ...
          >
            {isSharing ? (
              ...
              <>
                ...
                Share with {recipientsList.length}{' '}
