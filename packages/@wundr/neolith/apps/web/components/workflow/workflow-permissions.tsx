...
interface WorkflowPermissionsProps {
  ...
  onUpdateSharingConfig: (
    config: Partial<WorkflowSharingConfig>
  ) => Promise<void>;
...
export function WorkflowPermissions({
  ...
  const [selectedSubjectType, setSelectedSubjectType] =
    useState<PermissionSubjectType>('user');
  const [isGeneratingLink, setIsGeneratingLink] = useState(false);
  const [showAccessLog, setShowAccessLog] = useState(false);
  const [expandedLogItems, setExpandedLogItems] = useState<Set<string>>(
    new Set()
  );
  ...
  return (
    <div className='space-y-6'>
            ...
            {sharingConfig.publicShareLink ? (
              <div className='flex gap-2'>
                ...
                <Button
                  ...
                  variant='outline'
                  onClick={() =>
                    onCopyShareLink(sharingConfig.publicShareLink!)
                  }
                >
                ...
                <Button
                  ...
                  variant='outline'
                  onClick={() =>
                    window.open(sharingConfig.publicShareLink, '_blank')
                  }
                >
      ...
      {sharingConfig.inheritWorkspacePermissions &&
            ...
            <div className='flex items-start gap-2'>
              ...
              <div className='flex-1 text-sm'>
                ...
                <p className='text-blue-700 dark:text-blue-300 mt-1'>
                  {workspacePermissions.length} permission(s) inherited from
                  workspace settings
                </p>
              </div>
            </div>
      ...
      <div className='flex gap-2'>
        ...
        <Select
          ...
          onValueChange={v =>
            setSelectedSubjectType(v as PermissionSubjectType)
          }
        >
                      ...
                      <TableCell>
                        <div className='flex items-center gap-3'>
                          <Avatar className='h-8 w-8'>
                            ...
                            <AvatarFallback>
                              {getInitials(permission.subjectName)}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          {log.details && (
                            <div className='mt-2'>
                              ...
                              >
                                {expandedLogItems.has(log.id) ? 'Hide' : 'Show'}{' '}
                                details
                              </Button>
