...
import { validateVariableReferences, replaceVariableReferences } from './variable-validation';
...
export function VariableManagerDemo() {
  ...
  const [stepConfigs, setStepConfigs] = React.useState({
    step1: {
      message: 'Welcome ${variable.userName}! We sent a confirmation to ${variable.userEmail}.',
      channelId: '${variable.channelId}',
    },
    step2: {
      profileData: '{"name": "${variable.userName}", "email": "${variable.userEmail}", "isAdmin": ${variable.isAdmin}}',
    },
    step3: {
    ...
    <div className="container mx-auto py-8 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          A comprehensive demonstration of the workflow variable management system
        </p>
      </div>
        ...
        <TabsContent value="manager" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Define and manage variables that can be used throughout your workflow
              </CardDescription>
            </CardHeader>
            <CardContent>
              <VariableManager
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {variables.filter((v) => v.scope === 'global').length === 0 && (
        ...
        <TabsContent value="usage" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {/* Validation Results */}
              {(() => {
                const messageValidation = validateConfig(stepConfigs.step1.message);
                const channelValidation = validateConfig(stepConfigs.step1.channelId);
                const hasErrors =
