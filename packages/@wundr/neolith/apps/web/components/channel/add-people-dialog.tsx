...
export function AddPeopleDialog({
  ...
  }, [searchQuery, recipients.length, searchResults, highlightedIndex, handleSelectRecipient]);
  ...
  const handleSubmit = useCallback(async (includeHistory: boolean) => {
  ...
  const remainingSlots = Math.max(0, maxPeople - currentMemberCount - recipients.length);
            ...
            <div className="space-y-4 mt-2">
              ...
              >
                ...
                <Input
                  ...
                  placeholder={recipients.length === 0 ? 'e.g. Matt or @mbrewer' : ''}
              ...
              {remainingSlots <= 3 && remainingSlots > 0 && (
                <p className="text-xs text-muted-foreground">
                  You can add {remainingSlots} more {remainingSlots === 1 ? 'person' : 'people'}.
                </p>
              )}
            ...
            <div className="space-y-4 mt-2">
              ...
              <div className="rounded-lg border p-4">
                <p className="text-sm text-muted-foreground mb-3">
                  Adding {recipients.length} {recipients.length === 1 ? 'person' : 'people'}:
                </p>
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="text-left">
                    <p className="font-medium">Yes, share the conversation history</p>
              ...
              {isSubmitting && (
                <div className="flex items-center justify-center py-2">
                  <LoadingSpinner size="sm" />
                  <span className="ml-2 text-sm text-muted-foreground">Adding people...</span>
                </div>
              )}
            </div>
          </>
