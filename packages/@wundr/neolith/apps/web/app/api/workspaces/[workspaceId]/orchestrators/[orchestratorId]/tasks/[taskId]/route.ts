/**
 * OrchestratorTask Detail Route
 *
 * Individual task operations for Orchestrator autonomous operation management.
 * Provides detailed task retrieval, updates, and deletion.
 *
 * Routes:
 * - GET /api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId] - Get task details
 * - PATCH /api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId] - Update task
 * - DELETE /api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId] - Delete/cancel task
 *
 * @module app/api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId]/route
 */
...
/**
 * GET /api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId]
 *
 ...
 * - Related entities (Orchestrator, workspace, channel, creator, assignee)
 *
 * @param request - Next.js request object
 * @param params - Route parameters (workspaceId, orchestratorId, taskId)
 * @returns Complete task details with relations
 *
 * @example
 * ```
 * GET /api/workspaces/ws_123/orchestrators/orch_456/tasks/task_789
 * ```
 */
export async function GET(
  _request: NextRequest,
  { params }: { params: Promise<{ workspaceId: string; orchestratorId: string; taskId: string }> },
  ...
  try {
    ...
    const { workspaceId, orchestratorId, taskId } = resolvedParams;
...
/**
 * PATCH /api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId]
 *
 ...
 * @example
 * ```
 * PATCH /api/workspaces/ws_123/orchestrators/orch_456/tasks/task_789
 * Body: {
 *   "status": "IN_PROGRESS",
...
/**
 * DELETE /api/workspaces/[workspaceId]/orchestrators/[orchestratorId]/tasks/[taskId]
 *
 ...
 * @example
 * ```
 * DELETE /api/workspaces/ws_123/orchestrators/orch_456/tasks/task_789?reason=Duplicate+task
 * DELETE /api/workspaces/ws_123/orchestrators/orch_456/tasks/task_789?permanent=true
 * ```
 */
