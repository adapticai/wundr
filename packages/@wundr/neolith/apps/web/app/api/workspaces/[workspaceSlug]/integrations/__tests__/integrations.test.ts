...
describe('Integrations API Routes', () => {
  ...
  describe('POST /api/workspaces/:workspaceId/integrations', () => {
    it('creates integration with valid data', async () => {
      ...
      // Call mock service
      const result =
        await mockIntegrationService.createIntegration(requestBody);
  ...
  describe('GET /api/integrations/:id', () => {
    ...
    it('returns 404 when integration not found', async () => {
      ...
      const result =
        await mockIntegrationService.getIntegration('non-existent');
  ...
  describe('POST /api/integrations/:id/sync', () => {
    it('syncs integration data', async () => {
      ...
      const result =
        await mockIntegrationService.syncIntegration('int_test123');
...
describe('Webhooks API Routes', () => {
  ...
  describe('PATCH /api/webhooks/:id', () => {
    ...
    it('updates webhook events', async () => {
      ...
      const updatedEvents: WebhookEventType[] = [
        'message.created',
        'message.updated',
        'message.deleted',
      ];
