 ...
 *
 * List webhooks for a workspace with optional filters.
 *
 * Query parameters:
 ...
 * Returns the webhook configuration and secret (secret is only shown once).
 *
 * Request body:
