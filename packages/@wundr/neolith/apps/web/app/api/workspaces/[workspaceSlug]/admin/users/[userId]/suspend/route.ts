/**
 * Admin User Suspend API Routes
 *
 * Handles user suspension.
 *
 * Routes:
 * - POST /api/workspaces/:workspaceSlug/admin/users/:userId/suspend - Suspend user
 *
 * @module app/api/workspaces/[workspaceSlug]/admin/users/[userId]/suspend/route
 */
...
/**
 * POST /api/workspaces/:workspaceSlug/admin/users/:userId/suspend
 *
