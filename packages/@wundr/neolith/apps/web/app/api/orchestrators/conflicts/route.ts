/**
 * OrchestratorConflict Resolution API Route
 *
 * Handles resolving conflicts between multiple VPs.
 *
 * Routes:
 * - POST /api/orchestrators/conflicts - Resolve a conflict between VPs
 *
 * @module app/api/orchestrators/conflicts/route
 */

import { NextResponse } from 'next/server';

import { auth } from '@/lib/auth';
import { resolveConflict } from '@/lib/services/orchestrator-coordination-service';
import {
...
import type { ConflictResolutionInput } from '@/lib/validations/orchestrator-coordination';
