 ...
 *
 * Routes:
 * - GET /api/vps/[id]/backlog/[itemId] - Get backlog item details
 * - PATCH /api/vps/[id]/backlog/[itemId] - Update backlog item
 * - DELETE /api/vps/[id]/backlog/[itemId] - Remove backlog item
 *
 * @module app/api/vps/[id]/backlog/[itemId]/route
 */
 ...
 * @param params - Route parameters (id = VP ID, itemId = BacklogItem ID)
 * @returns Backlog item with task details
 *
 * @example
 * ```
 * GET /api/vps/vp_123/backlog/backlog_item_456
 * ```
 */
export async function GET(
  ...
  try {
    ...
    // Get VP ID and item ID from params
    ...
    // Verify VP exists and get workspace
    ...
    // Verify the backlog item belongs to the requested VP
    if (backlogItem.backlog.vpId !== vpId) {
      return NextResponse.json(
        createErrorResponse('Backlog item does not belong to this VP', TASK_ERROR_CODES.FORBIDDEN),
        { status: 403 },
      );
    }
    ...
    console.error('[GET /api/vps/[id]/backlog/[itemId]] Error:', error);
    return NextResponse.json(
...
/**
 * PATCH /api/vps/[id]/backlog/[itemId]
 *
 ...
 * @example
 * ```
 * PATCH /api/vps/vp_123/backlog/backlog_item_456
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[PATCH /api/vps/[id]/backlog/[itemId]] Error:', error);
...
/**
 * DELETE /api/vps/[id]/backlog/[itemId]
 *
 ...
 * @example
 * ```
 * DELETE /api/vps/vp_123/backlog/backlog_item_456
 * ```
 */
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /api/vps/[id]/backlog/[itemId]] Error:', error);
