...
const STATUS_CONFIG = {
  TODO: { label: 'To Do', color: 'text-blue-600', bgColor: 'bg-blue-50 dark:bg-blue-900/20' },
  IN_PROGRESS: { label: 'In Progress', color: 'text-yellow-600', bgColor: 'bg-yellow-50 dark:bg-yellow-900/20' },
  BLOCKED: { label: 'Blocked', color: 'text-red-600', bgColor: 'bg-red-50 dark:bg-red-900/20' },
  DONE: { label: 'Done', color: 'text-green-600', bgColor: 'bg-green-50 dark:bg-green-900/20' },
  CANCELLED: { label: 'Cancelled', color: 'text-gray-600', bgColor: 'bg-gray-50 dark:bg-gray-900/20' },
} as const;
...
export default function TasksPage() {
  ...
  // Hooks
  const { tasks, isLoading, error, refetch } = useTasks(workspaceId, {
      ...
      <div className="rounded-lg border bg-card p-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <select
            ...
            onChange={(e) => setPriorityFilter(e.target.value as TaskPriorityType | 'all')}
            className="rounded-md border border-input bg-background px-3 py-2 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
          >
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-start gap-2">
            <span className="text-lg" title={`Priority: ${priorityConfig.label}`}>
              {priorityConfig.icon}
            </span>
            <div className="flex-1">
