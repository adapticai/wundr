...
export default function AdminRolesPage() {
  ...
  const handleDelete = useCallback(
    async (roleId: string) => {
      if (window.confirm('Are you sure you want to delete this role? Members with this role will be assigned the default member role.')) {
  ...
  const availablePermissions: Permission[] = [
    { id: 'channels.create', name: 'Create Channels', description: 'Create new channels in the workspace' },
    { id: 'channels.delete', name: 'Delete Channels', description: 'Delete channels from the workspace' },
    { id: 'channels.manage', name: 'Manage Channels', description: 'Edit channel settings and permissions' },
    { id: 'members.invite', name: 'Invite Members', description: 'Invite new members to the workspace' },
    { id: 'members.remove', name: 'Remove Members', description: 'Remove members from the workspace' },
    { id: 'members.manage', name: 'Manage Members', description: 'Change member roles and settings' },
    ...
    { id: 'billing.manage', name: 'Manage Billing', description: 'Update payment and subscription' },
  ];
