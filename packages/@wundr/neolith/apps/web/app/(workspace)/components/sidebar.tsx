...
export function Sidebar({
  ...
  const workspaceId =
    (params.workspaceSlug as string) || currentWorkspace?.id || '';
  ...
  const handleChannelStarChange = useCallback(
    (channelId: string, isStarred: boolean) => {
      console.log('[Sidebar] handleChannelStarChange called:', {
        channelId,
        isStarred,
      });
  ...
  const handleDMStarChange = useCallback(
