...
export default function PlansUsagePage() {
  ...
  const storageUsagePercent =
    plan.limits.storage > 0 ? (usage.storage / plan.limits.storage) * 100 : 0;
            ...
            <div className='flex items-center gap-4 border-t pt-4 text-sm'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-muted-foreground'>
                  Billing Cycle:{' '}
                  {new Date(billingCycle.start).toLocaleDateString()} -{' '}
                  {new Date(billingCycle.end).toLocaleDateString()}
                </span>
              </div>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-muted-foreground'>
                  Next billing:{' '}
                  {new Date(billingCycle.nextBillingDate).toLocaleDateString()}
                </span>
              </div>
            </div>
          )}
