...
export function MemberDashboardSection({ workspaceId }: MemberDashboardSectionProps) {
  ...
  useEffect(() => {
    const fetchMemberData = async () => {
      try {
        const response = await fetch(`/api/workspaces/${workspaceId}/dashboard/member-info`);
        ...
        if (response.ok) {
          ...
          setData({
            ...
            checklist: [
              { id: '1', label: 'Complete your profile', completed: false, href: '/profile' },
              { id: '2', label: 'Join your first channel', completed: false, href: `/${workspaceId}/channels` },
              { id: '3', label: 'Send your first message', completed: false },
              { id: '4', label: 'Explore orchestrators', completed: false, href: `/${workspaceId}/orchestrators` },
            ],
            suggestedChannels: [
              {
                id: 'ch_1',
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Popular channels you might want to join</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-3">
      ...
      {data.recommendedOrchestrators.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>AI assistants to help you work faster</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {data.recommendedOrchestrators.map((orchestrator) => (
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-sm">{orchestrator.name}</span>
