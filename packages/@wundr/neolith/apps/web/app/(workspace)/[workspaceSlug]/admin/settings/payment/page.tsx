...
export default function PaymentMethodsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`/api/workspaces/${workspaceSlug}/billing/payment-methods`);
      if (!response.ok) {
  ...
  }, [workspaceSlug, cardNumber, cardHolder, expiryMonth, expiryYear, cvv, toast, fetchData]);
