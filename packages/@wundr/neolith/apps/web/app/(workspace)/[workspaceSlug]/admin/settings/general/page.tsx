...
export default function GeneralSettingsPage() {
  ...
  useEffect(() => {
    if (settings) {
      ...
      setDefaultTimezone((settings as any).defaultTimezone || Intl.DateTimeFormat().resolvedOptions().timeZone);
  ...
  }, [defaultChannelId, defaultTimezone, defaultLanguage, updateSettings, toast]);
  ...
  const handleSaveDiscoverability = useCallback(async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: error instanceof Error ? error.message : 'Failed to save discoverability',
        variant: 'destructive',
      });
    } finally {
      setIsSaving(false);
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your workspace's name, icon, and description are displayed throughout the platform
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground flex items-start gap-1">
                ...
                The workspace URL cannot be changed after creation to maintain consistency across integrations
              </p>
            </div>
          </div>
              ...
              <SelectContent>
                ...
                <SelectItem value="public">
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-xs text-muted-foreground">Anyone can request to join</span>
                  </div>
                </SelectItem>
              </SelectContent>
            </Select>
            ...
            <div>
              ...
              <p className="text-sm">
                {(settings as any)?.createdAt
                  ? new Date((settings as any).createdAt).toLocaleDateString('en-US', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric',
                    })
