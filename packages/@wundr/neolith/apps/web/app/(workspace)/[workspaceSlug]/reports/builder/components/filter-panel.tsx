...
export function FilterPanel({
  ...
  const handleSaveFilter = () => {
    ...
    const existingIndex = filters.findIndex(
      (f) => f.field === editingFilter.field && f.operator === editingFilter.operator
    );
          ...
          {filters.map((filter, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium truncate">{filter.field}</div>
            ...
            <div className="space-y-3 p-3 border rounded-md">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingFilter({ ...editingFilter, field: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingFilter({ ...editingFilter, value: e.target.value })
                  }
                  className="h-8 text-sm"
                />
              </div>
