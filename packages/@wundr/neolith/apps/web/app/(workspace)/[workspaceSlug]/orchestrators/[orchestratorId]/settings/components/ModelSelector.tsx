...
export function ModelSelector({ config, onSave, disabled }: ModelSelectorProps) {
  ...
  const handleProviderChange = (provider: string) => {
    const defaultModel =
      provider === 'anthropic' ? 'claude-3-5-sonnet-20241022' : 'gpt-4-turbo-preview';
    setFormData({
      ...formData,
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Choose and configure the AI model for your orchestrator</CardDescription>
        </CardHeader>
              ...
              <div className="text-sm space-y-1">
                ...
                {formData.llmProvider === 'openai' && (
                  <>
                    ...
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Function Calling:</span>
                      <span>Supported</span>
                    </div>
                  </>
                )}
