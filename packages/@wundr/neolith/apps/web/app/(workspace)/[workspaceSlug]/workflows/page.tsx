...
export default function WorkflowsPage() {
  ...
  // Hooks
  const { workflows, isLoading, error, createWorkflow, mutate } = useWorkflows(workspaceSlug, {
    status: statusFilter === 'all' ? undefined : statusFilter,
  });
  const { templates, isLoading: templatesLoading } = useWorkflowTemplates(workspaceSlug);
