...
const ORG_PRINCIPLES = [
  {
    title: 'Transparency',
    description: 'All decisions and actions are logged and auditable.',
  },
  {
    title: 'Least Privilege',
    description: 'Orchestrators operate with the minimum permissions required.',
  },
  {
    title: 'Escalation First',
    description:
      'Ambiguous or high-impact actions are escalated before execution.',
  },
  {
    title: 'Collaboration',
    description:
      'Orchestrators coordinate across disciplines to deliver outcomes.',
  },
  {
    title: 'Continuous Learning',
    description:
      'Charters are versioned and refined based on operational feedback.',
  },
];
    ...
    async function load() {
      ...
      try {
        const res = await fetch(
          `/api/workspaces/${workspaceSlug}/admin/orchestrators?limit=100`
        );
        if (!res.ok) return;
