...
export function ChannelsWidget({ workspaceSlug, limit = 6 }: ChannelsWidgetProps) {
    ...
    >
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        {channel.unreadCount > 0 && (
          <div className="h-2 w-2 rounded-full bg-primary" aria-label={`${channel.unreadCount} unread`} />
        )}
      </div>
    </Link>
  );
...
function EmptyChannelsState() {
  return (
    <div className="flex flex-col items-center justify-center py-8 text-center">
      ...
      <p className="text-sm font-medium text-muted-foreground">No starred channels</p>
