            ...
            {executionsLoading && executions.length === 0 ? (
              ...
              <div className="py-8 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  This workflow hasn&apos;t been executed yet. Click the Execute button above to run it.
                </p>
              </div>
            ) : (
              <>
          ...
          <div className="rounded-lg border bg-card p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{workflow.errorCount}</p>
              </div>
              <div>
    ...
    <div className="relative">
      <div className="flex items-start gap-3">
        <div className="flex flex-col items-center">
          ...
          {!isLast && (
            <div className="h-full w-0.5 flex-1 bg-border" style={{ minHeight: '40px' }} />
          )}
        </div>
        <div className="flex-1 rounded-lg bg-muted/50 p-4">
          ...
          <p className="mt-1 text-sm text-muted-foreground">{actionConfig.description}</p>
      ...
      <div className="mt-3 space-y-1 text-sm">
        <div className="flex items-center justify-between">
          ...
          <span className="font-medium">
            {execution.actionResults.filter((a) => a.status === 'completed').length}/
