...
import { formatFileSize, getFileExtension, detectFileType, truncateFilename } from './utils';
 ...
 */
export const GenericFilePreview = React.forwardRef<HTMLDivElement, GenericFilePreviewProps>(
