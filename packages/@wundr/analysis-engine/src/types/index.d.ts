...
export type EntityType = 'class' | 'interface' | 'type' | 'enum' | 'function' | 'method' | 'const' | 'variable' | 'service' | 'component' | 'hook' | 'utility' | 'comment' | 'whitespace';
...
export type CodeSmellType = 'long-method' | 'large-class' | 'duplicate-code' | 'dead-code' | 'complex-conditional' | 'feature-envy' | 'inappropriate-intimacy' | 'god-object' | 'wrapper-pattern' | 'deep-nesting' | 'long-parameter-list';
...
export type RecommendationType = 'MERGE_DUPLICATES' | 'REMOVE_DEAD_CODE' | 'REFACTOR_WRAPPER' | 'BREAK_CIRCULAR_DEPS' | 'REDUCE_COMPLEXITY' | 'EXTRACT_METHOD' | 'CONSOLIDATE_INTERFACES' | 'OPTIMIZE_IMPORTS';
