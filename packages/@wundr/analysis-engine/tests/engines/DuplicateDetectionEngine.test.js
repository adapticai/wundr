...
describe('DuplicateDetectionEngine', () => {
    ...
    describe('Hash-based duplicate detection', () => {
        it('should detect exact duplicates using normalized hash', async () => {
            ...
            const duplicateHash = (0, utils_1.generateNormalizedHash)({ id: 'number', name: 'string' });
        ...
        it('should detect semantic duplicates using semantic hash', async () => {
            ...
            const semanticHash = (0, utils_1.generateSemanticHash)({ methods: ['save', 'load'] });
    ...
    describe('Consolidation suggestions', () => {
        it('should suggest merge strategy for interfaces', async () => {
            ...
            expect(result[0].consolidationSuggestion?.steps).toContain('Merge interface/type definitions into a single declaration');
        });
        it('should suggest extract strategy for classes', async () => {
            ...
            expect(result[0].consolidationSuggestion?.steps).toContain('Extract common functionality into a shared base class or utility');
        });
    });
    ...
    describe('Configuration options', () => {
        it('should respect minimum similarity threshold', async () => {
            const lowSimilarityEngine = new DuplicateDetectionEngine_1.DuplicateDetectionEngine({
        ...
        it('should limit cluster size according to maxClusterSize', async () => {
            const limitedEngine = new DuplicateDetectionEngine_1.DuplicateDetectionEngine({
                maxClusterSize: 3
            });
            const entities = [];
    ...
    function createMockEntity(name, type, members) {
        return {
            ...
            semanticHash: (0, utils_1.generateSemanticHash)(members || { name, type }),
            members,
            complexity: {
                cyclomatic: 1,
                cognitive: 0,
