...
WebSocket server and Neolith backend integration for VP (Virtual Principal) daemons.

## Overview

The VP Daemon package provides a robust WebSocket server infrastructure for real-time communication between VP daemon clients and the Neolith backend. It includes:
...
- Documentation: https://docs.wundr.io/vp-daemon
