 ...
 */
export type ProjectType = 'frontend' | 'backend' | 'fullstack' | 'monorepo' | 'library' | 'cli' | 'api' | 'mobile';
export type FrameworkType = 'next' | 'react' | 'vue' | 'fastify' | 'express' | 'nestjs' | 'turborepo' | 'react-native';
