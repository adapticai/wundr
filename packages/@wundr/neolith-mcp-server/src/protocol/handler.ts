...
import type {
  ...
  Logger,
  MCPServerConfig,
  TextContent} from '../types/protocol-types';
...
export class MCPProtocolHandler {
  ...
  public async start(): Promise<void> {
    this.logger.info('Starting Neolith MCP Protocol Handler');
    await this.transport.start();
    this.logger.info('Neolith MCP Protocol Handler started, waiting for initialization');
  }
  ...
  public async stop(): Promise<void> {
    this.logger.info('Stopping Neolith MCP Protocol Handler');
    this.state = 'shutdown';
    ...
    this.logger.info('Neolith MCP Protocol Handler stopped');
  }
  ...
  private async handleInitialize(params: Record<string, unknown>): Promise<InitializeResult> {
    ...
    return {
      ...
      instructions: 'Neolith MCP Server - Provides workspace-aware tools for the Neolith platform.',
    };
  }
